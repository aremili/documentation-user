...
Definitions
    "Personal Data", "Controller", "Processing", "Subprocessor" take the same meanings as in the
    applicable Data Protection Regulation, including European Directives 95/46/EC and 2002/58/EC,
...
- (a) only process the data when and as instructed by the Customer, and for the purpose of
  ...
  forbids it ;
- (b) ensure that all persons within Odoo SA authorised to process the data have committed
  themselves to confidentiality ;
- (c) implement and maintain appropriate technical and organizational measures to protect
  the data against unauthorized or unlawful processing and against accidental loss,
...
- (d) forward promptly to the Customer any Data Protection request that was submitted
  to Odoo SA with regard to the contents of the Customer's database ;
...
- (g) permanently delete all copies of the Customer's database in possession of Odoo SA,
  upon termination of this Agreement, subject to the delays specified in Odoo SA's
